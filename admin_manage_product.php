...
if (isset($_POST['add_product'])) {
    ...
    if (empty($product_name) || empty($product_categ) || empty($product_desc) || empty($product_model) || empty($product_brand) || empty($product_price) || empty($imagePath) || empty($product_stock) || empty($product_specification)) {
        ...
        $insert = $conn->prepare("INSERT INTO products (product_name, product_img, description, category_name, brand, model, price, stock_quantity, specification) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="admin_manage_product.php?delete=<?php echo $row['product_id']; ?>" class="btn btn-danger btn-sm text-white" onclick="return confirmDeletion()">
